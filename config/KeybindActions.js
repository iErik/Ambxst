...
var ACTION_CATALOG = [
    ...
    { id: "audio.volume-up", label: "Volume Up", category: "Audio", dispatcher: "exec", argument: "ambxst volume up", flags: "le" },
    { id: "audio.volume-down", label: "Volume Down", category: "Audio", dispatcher: "exec", argument: "ambxst volume down", flags: "le" },
    { id: "audio.mute-toggle", label: "Mute Audio", category: "Audio", dispatcher: "exec", argument: "ambxst volume mute", flags: "le" },
...
function actionFromLegacy(dispatcher, argument, flags) {
    ...
    if (dispatcher === "exec") {
        ...
        if (arg.indexOf("ambxst volume up") === 0 || arg.indexOf("qs ipc call audio increment") === 0 || (arg.indexOf("wpctl set-volume") === 0 && arg.indexOf("10%+") !== -1)) return { id: "audio.volume-up", args: {} };
        if (arg.indexOf("ambxst volume down") === 0 || arg.indexOf("qs ipc call audio decrement") === 0 || (arg.indexOf("wpctl set-volume") === 0 && arg.indexOf("10%-") !== -1)) return { id: "audio.volume-down", args: {} };
        if (arg.indexOf("ambxst volume mute") === 0 || arg.indexOf("qs ipc call audio toggleMute") === 0 || arg.indexOf("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle") === 0) return { id: "audio.mute-toggle", args: {} };
