...
Singleton {
    ...
    readonly property string repoUrl: "https://api.github.com/repos/iErik/Ambxst/tags"
    readonly property string changelogUrl: "https://github.com/iErik/Ambxst/releases"
