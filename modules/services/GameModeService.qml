                ...
                try {
                    ...
                    if (content) {
                        ...
                        if (states.gameMode !== undefined) {
                            ...
                            // Apply if enabled. Niri cannot take Hyprland keywords;
                            // CompositorTomlWriter writes animations.enabled from toggled.
                            if (root.toggled && !Quickshell.env("NIRI_SOCKET")) {
