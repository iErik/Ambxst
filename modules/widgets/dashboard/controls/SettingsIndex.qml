...
QtObject {
    ...
    readonly property var staticItems: [
        ...
        { label: "Overview Keybind", keywords: "workspace mission control shortcut super shift tab", section: 5, subSection: "", subLabel: "Binds > Ambxst", icon: Icons.keyboard, isIcon: true },
        { label: "Task Switcher Keybind", keywords: "alt tab window cycle shortcut super tab", section: 5, subSection: "", subLabel: "Binds > Ambxst", icon: Icons.keyboard, isIcon: true },
        ...
        { label: "Shadow Power", keywords: "strength render intensity", section: 7, subSection: "shadows", subLabel: "Compositor > AxctlService", icon: Icons.lightning, isIcon: true, hyprlandOnly: true },
        { label: "Shadow Scale", keywords: "zoom resize", section: 7, subSection: "shadows", subLabel: "Compositor > AxctlService", icon: Icons.cornersOut, isIcon: true, hyprlandOnly: true },
        { label: "Shadow Sharp", keywords: "crisp hard edges", section: 7, subSection: "shadows", subLabel: "Compositor > AxctlService", icon: Icons.cornersOut, isIcon: true, hyprlandOnly: true },
        { label: "Shadow Ignore Window", keywords: "behind overlay", section: 7, subSection: "shadows", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },

        // Compositor > AxctlService > Blur
        { label: "Blur Enabled", keywords: "toggle on off transparency", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur Size", keywords: "radius amount", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.circle, isIcon: true, hyprlandOnly: true },
        { label: "Blur Passes", keywords: "quality iterations", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.circle, isIcon: true, hyprlandOnly: true },
        { label: "Blur Xray", keywords: "transparency see through", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur New Optimizations", keywords: "performance speed", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.lightning, isIcon: true, hyprlandOnly: true },
        { label: "Blur Ignore Opacity", keywords: "transparency alpha", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur Ignorealpha", keywords: "explicit transparency", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur Ignorealpha Value", keywords: "threshold amount", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur Noise", keywords: "grain texture static", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur Contrast", keywords: "intensity difference", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur Brightness", keywords: "light dark level", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
        { label: "Blur Vibrancy", keywords: "saturation color", section: 7, subSection: "blur", subLabel: "Compositor > AxctlService", icon: Icons.drop, isIcon: true, hyprlandOnly: true },
